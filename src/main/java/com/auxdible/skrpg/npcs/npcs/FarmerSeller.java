...
public class FarmerSeller implements NPC {
    private Entity entity;
    private SKRPG skrpg;
    private Location location;
    private Entity hitbox, clickStand;
    public FarmerSeller(SKRPG skrpg, Location location) {
        this.skrpg = skrpg;
    ...
    public void buildNPC(SKRPG skrpg) {
        ...
        nameStand.setCustomName(Text.color("&aFarmer"));
        ...
        slime.setCustomName("farmerseller");
    ...
    public void onInteract(Player p, PlayerData playerData, SKRPG skrpg) {
        Inventory inv = Bukkit.createInventory(null, 54, "Farmer");
        for (int i = 0; i <= 53; i++) {
        ...
        inv.setItem(40, new ItemBuilder(Material.GOLD_NUGGET, 0)
                .setName("&7I'll buy any of your &6Herbalism &7related items for &6Nuggets!").asItem());
