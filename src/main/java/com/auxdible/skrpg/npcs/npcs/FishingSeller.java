...
public class FishingSeller implements NPC {
    private Entity entity;
    private SKRPG skrpg;
    private Location location;
    private Entity hitbox, clickStand;
    public FishingSeller(SKRPG skrpg, Location location) {
        this.skrpg = skrpg;
    ...
    public void buildNPC(SKRPG skrpg) {
        ...
        slime.setCustomName("fishingseller");
    ...
    public String getTypeID() {
        return "fishingseller";
    }

    @Override
    public void onInteract(Player p, PlayerData playerData, SKRPG skrpg) {
        Inventory inv = Bukkit.createInventory(null, 54, "Fisherman");
        for (int i = 0; i <= 53; i++) {
        ...
        inv.setItem(40, new ItemBuilder(Material.GOLD_NUGGET, 0)
                .setName("&7I'll buy any of your &6Fishing &7related items for &6Nuggets!").asItem());
