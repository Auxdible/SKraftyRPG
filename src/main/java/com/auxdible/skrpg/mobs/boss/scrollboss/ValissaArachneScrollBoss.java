...
public class ValissaArachneScrollBoss implements ScrollBoss {
            ...
            public void run() {
                ...
                if (attack == 0) {
                    if (lastDamager != null) {
                        ...
                        ItemInfo bootsInfo = ItemInfo.parseItemInfo(lastDamager.getInventory().getBoots());
                        Player permLastDamager = lastDamager;
                        ...
                        new BukkitRunnable() {
                            ...
                            public void run() {
                                ...
                                permLastDamager.damage(0.1f);
                                damagedData.setHp(damagedData.getHp() - 20);
                                permLastDamager.playSound(permLastDamager.getLocation(), Sound.ENTITY_SPIDER_HURT, 1.0f, 0.2f);
                                halfSeconds++;
                            }
    ...
    public void damage(int amount, Player player) {
        ...
        if (mob.getCurrentHP() - amount <= 0) {
            ...
            isDead = true;
            Text.applyText(lastDamager, "&4&lValissa Arachne &r&8&l| &r&cHe... was right... the monsters are being slain, everywhere... &cYou, you... &7won't get away with my death. &c&lThe Spider Kingdom &7has come to an end.");
