...
public class VillagerNPC implements NPC {
    ...
    public VillagerNPC(int id, Location location) {
        this.id = id;
    ...
    public void onInteract(Player p, PlayerData playerData, SKRPG skrpg) {
        ...
        if (randomDialogue == 0) {
            ...
            Text.applyText(p, "&e&lVillager &r&8| &7One of the oldest members of the town is &aThe King&7. He may have something for you.");
