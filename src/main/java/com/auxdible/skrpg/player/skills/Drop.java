...
public enum Drop {
    ...
    // FISHING DROPS
    DIAMOND_FISHING_DROP(0.05, Items.COMPACT_DIAMOND, DropRarity.LUCKY),
    GOLD_FISHING_DROP(0.05, Items.COMPACT_GOLD, DropRarity.LUCKY),
    GEMSTONE_FISHING_DROP(0.05, Items.COMPACT_GEMSTONE, DropRarity.LUCKY),
    EXPERT_ROD(0.15, Items.EXPERT_ROD, DropRarity.LUCKY),
    CRAB_FRAGMENT_FISHING(0.15, Items.CRAB_FRAGMENT, DropRarity.LUCKY);
