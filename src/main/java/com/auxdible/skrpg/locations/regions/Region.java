...
public class Region {
    ...
    private SKRPG skrpg;
    public Region(double x, double z, double x2, double z2, String name, SKRPG skrpg, Location spawnLocation,
    ...
    public int getID() { return skrpg.getRegionManager().getRegions().indexOf(this); }
}
