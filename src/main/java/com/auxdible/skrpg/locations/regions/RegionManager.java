...
public class RegionManager {
    ...
    public Region getRegion(int id) {
        ...
        Region region = new Region(x, z, x2, z2, name, skrpg,
    ...
    public void addRegion(String name, double x, double z, double x2, double z2, Location spawnLocation, Location raidLocation, double bannerX, double bannerY, double bannerZ, List<RegionFlags> regionFlags) {
        Region region = new Region(x, z, x2, z2, name, skrpg, spawnLocation, new Location(Bukkit.getWorld(skrpg.getConfig().getString("rpgWorld")),
