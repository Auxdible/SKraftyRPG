...
public enum Items {
    ...
    MINER_HELMET(Rarity.UNCOMMON, "Miner Helmet", ItemTweaker.dye(new ItemBuilder(Material.LEATHER_HELMET, 0).asItem(), 53, 0, 68), 0, 0, 50, 0, 0, 50, "MINER_HELMET", ItemType.ARMOR, null,
    ...
    MINER_CHESTPLATE(Rarity.UNCOMMON, "Miner Chestplate", ItemTweaker.dye(new ItemBuilder(Material.LEATHER_CHESTPLATE, 0).asItem(), 53, 0, 68), 0, 0, 50, 0, 0, 50, "MINER_CHESTPLATE", ItemType.ARMOR, null,
    ...
    MINER_LEGGINGS(Rarity.UNCOMMON, "Miner Leggings", ItemTweaker.dye(new ItemBuilder(Material.LEATHER_LEGGINGS, 0).asItem(), 53, 0, 68), 0, 0, 50, 0, 0, 50, "MINER_LEGGINGS", ItemType.ARMOR, null,
    ...
    MINER_BOOTS(Rarity.UNCOMMON, "Miner Boots", ItemTweaker.dye(new ItemBuilder(Material.LEATHER_BOOTS, 0).asItem(), 53, 0, 68), 0, 0, 50, 0, 0, 50, "MINER_BOOTS", ItemType.ARMOR, null,
    ...
    DIAMOND_BOOTS(Rarity.UNCOMMON, "Diamond Boots", new ItemBuilder(Material.DIAMOND_BOOTS, 0).asItem(), 0, 0, 40, 0, 0, 10, "DIAMOND_BOOTS", ItemType.ARMOR, null,
            Arrays.asList(new CraftingIngrediant(Items.NONE, 0), new CraftingIngrediant(Items.NONE, 0), new CraftingIngrediant(Items.NONE, 0),
                    ...
                    new CraftingIngrediant(Items.DIAMOND, 1), new CraftingIngrediant(Items.NONE, 0), new CraftingIngrediant(Items.DIAMOND, 1)), 1, 30, SellMerchant.COMBAT, 20, false),
    /* ----- ZOMBIE ARMOR ----- */
    ZOMBIE_HELMET(Rarity.RARE, "Zombie Helmet", new ItemBuilder(Material.ZOMBIE_HEAD, 0).asItem(), 0, 0, 10, 0, 0, 75, "ZOMBIE_HELMET", ItemType.ARMOR, null,
    ...
    ZOMBIE_CHESTPLATE(Rarity.RARE, "Zombie Chestplate", ItemTweaker.dye(new ItemBuilder(Material.LEATHER_CHESTPLATE, 0).asItem(), 0, 153, 51), 0, 0, 10, 0, 0, 75, "ZOMBIE_CHESTPLATE", ItemType.ARMOR, null,
    ...
    ZOMBIE_LEGGINGS(Rarity.RARE, "Zombie Leggings", ItemTweaker.dye(new ItemBuilder(Material.LEATHER_LEGGINGS, 0).asItem(), 0, 153, 51), 0, 0, 10, 0, 0, 75, "ZOMBIE_LEGGINGS", ItemType.ARMOR, null,
            Arrays.asList(new CraftingIngrediant(Items.ZOMBIE_FRAGMENT, 1), new CraftingIngrediant(Items.ZOMBIE_FRAGMENT, 1), new CraftingIngrediant(Items.ZOMBIE_FRAGMENT, 1),
                    new CraftingIngrediant(Items.ZOMBIE_FRAGMENT, 1), new CraftingIngrediant(Items.NONE, 0), new CraftingIngrediant(Items.ZOMBIE_FRAGMENT, 1),
    ...
    ZOMBIE_BOOTS(Rarity.RARE, "Zombie Boots", ItemTweaker.dye(new ItemBuilder(Material.LEATHER_BOOTS, 0).asItem(), 0, 153, 51), 0, 0, 10, 0,50, 75, "ZOMBIE_BOOTS", ItemType.ARMOR, null,
            Arrays.asList(new CraftingIngrediant(Items.NONE, 0), new CraftingIngrediant(Items.NONE, 0), new CraftingIngrediant(Items.NONE, 0),
                    new CraftingIngrediant(Items.ZOMBIE_FRAGMENT, 1), new CraftingIngrediant(Items.NONE, 0), new CraftingIngrediant(Items.ZOMBIE_FRAGMENT, 1),
                    new CraftingIngrediant(Items.ZOMBIE_FRAGMENT, 1), new CraftingIngrediant(Items.NONE, 0), new CraftingIngrediant(Items.ZOMBIE_FRAGMENT, 1)), 1, 30, SellMerchant.COMBAT, 25000, false),
    /* ----- GOLD ARMOR ----- */
    ...
    /* ----- KING ITEMS ----- */
    KING_STAFF(Rarity.MYTHICAL, "King's Staff", new ItemBuilder(Material.GOLDEN_SHOVEL, 0).asItem(), 80, 50, 50, 300, 50, 100, "KING_STAFF", ItemType.WEAPON, Arrays.asList("&6Long Live The King!", "&7You have done a &6great &7service to the King.", "&7As a gift, you have been granted this special &6staff&7."),
            SellMerchant.COMBAT, 1000000, false),
    EXCALIBUR(Rarity.MYTHICAL, "Excalibur", new ItemBuilder(Material.GOLDEN_SWORD, 0).asItem(), 175, 125, 0, 0, 50, 100, "EXCALIBUR", ItemType.WEAPON, Arrays.asList("&6The King's Sword.", "&7Legend says, it will be granted to a", "young, noble warrior to the &6crown&7."),
            SellMerchant.COMBAT, 1000000, false),
    KING_CROWN(Rarity.EPIC, "King's Crown", new ItemBuilder(Material.GOLDEN_HELMET, 0).asItem(), 20, 10, 100, 0, 200, 0, "KING_CROWN", ItemType.ARMOR, Arrays.asList("&6Long Live The King!"), SellMerchant.COMBAT, 50000, false),
    KING_ROBE_BREASTPLATE(Rarity.EPIC, "King's Robe (Breastplate)", ItemTweaker.dye(new ItemBuilder(Material.LEATHER_CHESTPLATE, 0).asItem(), 255, 0, 0), 20, 10, 100, 0, 200, 0, "KING_ROBE_BREASTPLATE", ItemType.ARMOR, Arrays.asList("&6Long Live The King!"), SellMerchant.COMBAT, 50000, false),
    KING_ROBE_TROUSERS(Rarity.EPIC, "King's Robe (Trousers)", ItemTweaker.dye(new ItemBuilder(Material.LEATHER_LEGGINGS, 0).asItem(), 255, 0, 0), 20, 10, 100, 0, 200, 0, "KING_ROBE_TROUSERS", ItemType.ARMOR, Arrays.asList("&6Long Live The King!"), SellMerchant.COMBAT, 50000, false),
    KING_BOOTS(Rarity.EPIC, "King's Boots", ItemTweaker.dye(new ItemBuilder(Material.LEATHER_BOOTS, 0).asItem(), 0, 0, 0), 20, 10, 100, 0, 200, 0, "KING_BOOTS", ItemType.ARMOR, Arrays.asList("&6Long Live The King!"), SellMerchant.COMBAT, 50000, false),
    ARCHER_LONGBOW(Rarity.RARE, "Archer's Longbow", new ItemBuilder(Material.CROSSBOW, 0).asItem(), 75, 50, 0, 0, 0, 100, "ARCHER_LONGBOW", ItemType.WEAPON, null, SellMerchant.COMBAT, 10000, false),
    WARRIOR_BLADE(Rarity.RARE, "Warrior's Blade", new ItemBuilder(Material.IRON_SWORD, 0).asItem(), 75, 25, 50, 0, 20, 0, "WARRIOR_BLADE", ItemType.WEAPON, null, SellMerchant.COMBAT, 10000, false),
    // TODO WAND FUNCTIONALITY, PLATE FUNCTIONALITY, BOOK FUNCTIONALITY
    TRICKSTER_WAND(Rarity.RARE, "Trickster's Wand", new ItemBuilder(Material.BLAZE_ROD, 0).asItem(), 100, 10, 0, 200, 0, 25, "TRICKSTER_WAND", ItemType.WEAPON, null, SellMerchant.COMBAT, 10000, false),
    TANK_PLATE(Rarity.RARE, "Tank's Plate", new ItemBuilder(Material.IRON_DOOR, 0).asItem(), 10, 5, 500, 0, 100, 0, "TANK_PLATE", ItemType.WEAPON, Arrays.asList("&7While holding, all players near you will gain &a250 Defence ✿&7."), SellMerchant.COMBAT, 10000, false),
    HEALERS_BOOK(Rarity.RARE, "Healer's Book", new ItemBuilder(Material.ENCHANTED_BOOK, 0).asItem(), 10, 5, 200, 0, 200, 250, "HEALER_BOOK", ItemType.WEAPON, Arrays.asList("&7While holding, all players near you will gain &c10% regeneration&7."), SellMerchant.COMBAT, 10000, false);
